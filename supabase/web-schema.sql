...
CREATE INDEX IF NOT EXISTS idx_stock_batches_business ON stock_batches(business_id, product_id, received_at);
...
CREATE INDEX IF NOT EXISTS idx_return_events_business ON return_events(business_id, created_at DESC);
